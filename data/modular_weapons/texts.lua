...
texts.modules.charge.crew_effects = Text {
    [''] = "Increases charges of the crew member's abilities by 1, while also increasing the charge speed of abilities by 50%%",
    ['zh-Hans'] = '使该船员的能力的充能次数+1，同时令能力的充能速度加快50%%',
}
...
texts.crew_installed_modules = Text {
    [''] = '\n*Installed modules: [%s]',
    ['zh-Hans'] = '\n*已安装模块：[%s]',
}

texts.crew_power_effect = Text {
    [''] = 'Gains "%s" ability: %s',
    ['zh-Hans'] = '获得"%s"能力：%s',
}

texts.modify_crew = Text {
    [''] = "Configure modules for %s [%s]",
    ['zh-Hans'] = '为%s配置模块 [%s]',
}

texts.cannot_modify_crew = Text {
    [''] = "Cannot configure modules for %s",
    ['zh-Hans'] = '无法配置%s的模块',
}

texts.crew_name = Text {
    [''] = "Currently configuring modules for %s\nInstalled modules: %s",
    ['zh-Hans'] = '正在配置的船员：%s\n已安装模块：%s',
}
